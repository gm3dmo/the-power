...
# Secondary token is a token generated by a user different than the primary
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--secondary-token",
        action="store",
        dest="secondary_token",
        default="secondary_token",
        help="A secondary personal access token.",
    )
    parser.add_argument(
        "--secondary-email",
        action="store",
        dest="secondary_email",
        default="secondary_email@example.com",
        help="A secondary email address.",
    )
    parser.add_argument(
        "--pr-approver-token",
        action="store",
