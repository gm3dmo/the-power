...
# https://docs.github.com/en/rest/actions/cache?apiVersion=2022-11-28#set-github-actions-cache-retention-limit-for-a-repository
...
curl ${curl_custom_flags} \
     ...
     -H "Authorization: Bearer ${GITHUB_TOKEN}" \
        "${GITHUB_API_BASE_URL}/repos/${org}/${repo}/actions/cache/retention-limit" --data @${json_file}
